...
| [1.x](https://github.com/geirolz/fly4s/releases?q=v1.&expanded=false) |    11.x    | [10.x-11.x](https://github.com/geirolz/fly4s/tree/10.x-11.x) |
| [2.x](https://github.com/geirolz/fly4s/releases?q=v2.&expanded=false) |    12.x    |      [main](https://github.com/geirolz/fly4s/tree/main)      |
...
```sbt
libraryDependencies += "com.github.geirolz" %% "fly4s" % "2.0.0"
```
